...
def population(t, N):
    fN = np.zeros_like(N)
    gamma = -0.05  # [入力]: 人口の増減率(ロジスティクス方程式のパラメータ)を入力
...
N0 = np.zeros(1)
N0[0] = 12800    # [入力]:人口の初期値(1920年の人口を万人で入力。10万人なら10と入力)
begin_year = 2008  # [入力]: 解き始めの時刻を西暦で入力.西暦2000年なら2000と入力)
end_year = 2070  # [入力]: 終了時刻を西暦で入力.西暦2000年なら2000と入力)
